          ...
          <div className="mb-4 md:mb-6 pb-4 md:pb-6 border-b">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-black text-white px-4 md:px-6 py-2 rounded-lg font-bold hover:bg-gray-800 transition text-sm md:text-base whitespace-nowrap">
                CHECK
              </button>
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 md:px-4 py-2 md:py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-black text-sm md:text-base"
            />
          </div>
          ...
          <button 
            type="submit" 
            className="w-full bg-black text-white py-3 md:py-4 rounded-lg font-bold text-base md:text-lg hover:bg-gray-800 transition">
            BUY NOW
          </button>
        </form>
      </div>
